...
export class AgentRQACPClient implements acp.Client {
   ...
   * replacing whatever the gateway guessed from how it was launched.
   *
  ...
  async sendAgentToWorkspace(
    ...
    await sendAgentIdentity(this.mcpBridge, identity, {
      taskId: this.getTaskIdForSession(sessionId),
      sessionId,
    });
  }
